...
public class Bai05FibonacciSwing extends JFrame {
    ...
    private void hienThiFibonacci() {
        try {
            ...
            if (n <= 0 || n > 92) {
                JOptionPane.showMessageDialog(this, "n phải từ 1 đến 92 để tránh tràn số long!", "Cảnh báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
            txtArea.setText(taoDayFibonacci(n));
        } catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "n phải là số nguyên dương!", "Lỗi định dạng", JOptionPane.ERROR_MESSAGE);
        }
    }
